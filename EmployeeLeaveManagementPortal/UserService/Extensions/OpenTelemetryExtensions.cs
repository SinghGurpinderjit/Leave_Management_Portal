        ...
        IConfiguration configuration)
    {
        services.AddOpenTelemetry()
            .ConfigureResource(resource => resource
                .AddService("user-service"))  // Service name in Jaeger UI
            .WithTracing(tracing =>
            {
                tracing
                    ...
                    .AddOtlpExporter(options =>
                    {
                        ...
                        var agentPort = int.Parse(configuration["JAEGER_AGENT_PORT"] ?? "4317");
        ...
        Log.Information("OpenTelemetry distributed tracing configured for UserService");
        return services;
    }
}
